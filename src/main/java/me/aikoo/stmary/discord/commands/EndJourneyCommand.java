...
public class EndJourneyCommand extends CommandAbstract {
  ...
  public void execute(SlashCommandInteractionEvent event, String language) {
    ...
    String formatted =
        (fromPlace.getTown() == destinationPlace.getTown() || !destinationPlace.isTownPlace())
    ...
    if (now < end) {
      ...
      String text =
          TextManager.createText("endjourney_journey_not_finsh", language)
    ...
    player.setCurrentLocationTown(
        destinationPlace.isTownPlace() ? destinationPlace.getTown().getId() : "");
