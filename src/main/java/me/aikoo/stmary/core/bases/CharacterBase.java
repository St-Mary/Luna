...
public class CharacterBase {
  ...
  public static class Information {
    ...
    @Getter private final HashMap<String, Dialog> dialogs;

    /**
     * Creates a new CharacterInformation instance with the specified id, name, description, and
     * dialogs.
     *
     ...
     */
    public Information(
        String id, String name, String description, HashMap<String, Dialog> dialogs) {
      this.id = id;
      this.name = name;
  ...
  public static class Option {
    ...
    @Getter private final ButtonStyle style;

    /** Get the dialog of the option. */
    @Getter private final Dialog dialog;
