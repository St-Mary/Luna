...
public class PlayerEntity {
     ...
     * Set the Discord id of the player.
     */
    @Getter
    @Setter
    ...
    /**
     * Get the current region location of the player.
     * Set the current region location of the player.
     */
    @Getter
    @Setter
    ...
    /**
     * Get the current town location of the player.
     * Set the current town location of the player.
     */
    @Getter
    @Setter
    ...
    /**
     * Get the current place location of the player.
     * Set the current place location of the player.
     */
    @Getter
    @Setter
     ...
     * Set the current experience of the player.
     */
    @Getter
    @Setter
    ...
    /**
     * Get the creation timestamp of the player.
     * Set the creation timestamp of the player.
     */
    @Getter
    @Setter
